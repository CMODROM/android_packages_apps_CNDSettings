...
import com.codenamedroid.settings.switches.PowerWidgetEnabler;
import com.codenamedroid.settings.switches.StatusBarBatteryEnabler;
import com.codenamedroid.settings.switches.BacklightEnabler;
...
import com.codenamedroid.settings.lists.InterfaceList;
import com.codenamedroid.settings.lists.MasterLists;
...
public class SlideSettings extends Activity {
    ...
    static {
        listHead.put(0, new InterfaceList());
    }
    ...
    public static class SettingsAdapter extends FragmentPagerAdapter {
        private final String[] tabs = {"Interface" };
    ...
    public static class ArrayListFragment extends ListFragment {
        ...
        private static class HeaderAdapter extends ArrayAdapter<Headers> {
            ...
            private final StatusBarBatteryEnabler mBatteryEnabler;
            private final BacklightEnabler mBacklightEnabler;
            ...
            public HeaderAdapter(Context context, List<Headers> objects) {
                ...
                mBatteryEnabler = new StatusBarBatteryEnabler(context, new Switch(context));
                mBacklightEnabler = new BacklightEnabler(context, new Switch(context));
            }
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                switch (headerType) {
                    ...
                    case HEADER_TYPE_SWITCH:
                        ...
                        } else if (header.mTitle == R.string.battery_settings_title) {
                            mBatteryEnabler.setSwitch(holder.switch_);
                        } else if (header.mTitle == R.string.backlight_settings_title) {
                            mBacklightEnabler.setSwitch(holder.switch_);
                        }
                        //$FALL-THROUGH$
                    case HEADER_TYPE_NORMAL:
            ...
            public void resume() {
                ...
                mBatteryEnabler.resume();
                mBacklightEnabler.resume();
            }
        
             public void pause() {
                 mWidgetEnabler.pause();
                 mBatteryEnabler.pause();
                 mBacklightEnabler.pause();
            }
