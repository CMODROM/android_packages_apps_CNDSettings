...
public class StatusBarClock extends Activity {
    ...
    public class StatusBarClockPreferences extends PreferenceFragment implements
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mClockStyle.setValue(Integer.toString(Settings.System.getInt(getApplicationContext()
            ...
            mClockAmPmstyle.setValue(Integer.toString(Settings.System.getInt(getApplicationContext()
            ...
            mAlarm.setChecked(Settings.System.getInt(getApplicationContext()
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (preference == mClockAmPmstyle) {
                ...
                result = Settings.System.putInt(getApplicationContext().getContentResolver(),
